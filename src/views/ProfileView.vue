<template>
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
        <div class="main-left col-span-1">
            <div class="p-4 bg-white border border-gray-200 flex flex-col items-center text-center rounded-lg">
                <img :src="user.get_avatar" class="mb-6 w-[150px] h-[150px] object-cover rounded-full">
